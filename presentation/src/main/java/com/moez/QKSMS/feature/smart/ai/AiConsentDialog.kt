        ...
        AlertDialog.Builder(context)
            ...
            .setMessage(
                "برای پیدا کردن کدهایی که موتور داخلی نتوانسته بخواند، متن پیامک‌های تبلیغاتی " +
                    ...
                    "فقط پیامک‌های تبلیغاتی‌ای فرستاده می‌شوند که موتور داخلی نتوانسته با اطمینان " +
                    "بخواند؛ لینک‌ها، نام شما و خط لغو پیش از ارسال حذف می‌شوند. " +
                    "این بررسی می‌تواند خودکار و در پس‌زمینه انجام شود، تا سقف روزانه‌ای که در " +
                    "تنظیمات تعیین می‌کنید. این اجازه را بعداً می‌توانید از تنظیمات لغو کنید."
            )
